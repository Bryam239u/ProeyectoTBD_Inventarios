...
namespace ProeyectoTBD_Inventarios.forms
{
    public partial class frmAgregarProductos : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            double precio = 0;
            if (!double.TryParse(textBox3.Text, out precio))
            {
            ...
            int idCategoriaSeleccionada = Convert.ToInt32(txtCategoria.Text);
            ...
            if (resultado == "OK")
            {
                ...
                this.Dispose(); // Cerramos el formulario de registro
            }
            else
            {
